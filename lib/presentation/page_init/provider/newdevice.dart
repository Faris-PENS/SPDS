...
class registerDevice extends StateNotifier<ResultState<bool>> {
  ...
  Future<void> registerDevices(String hwid, String place, double ampsR, double ampsS, double ampsT, double ampsU) async {
    state = const ResultState.loading();

    try {
      final success = await _remote.registerDevice(hwid: hwid, place: place,ampsR: ampsR, ampsS: ampsS, ampsT: ampsT, ampsU: ampsU);
